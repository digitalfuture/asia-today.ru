...
export default function createZenButtons() {
  ...
  zenButton1.innerHTML = `<a href='${zenLink}' target='_blank' title='ZEN' rel='noopener'><i></i></a>`
  ...
  zenButton2.innerHTML = `<a href='${zenLink}' target='_blank' title='ZEN' rel='noopener'></a>`
  ...
  zenButtonMobile.innerHTML = `<a href='${zenLink}' target='_blank' title='ZEN' rel='noopener'></a>`
  document

...
const headerBanner = headerBannerContainer.querySelector('.header-banner-container')
...
socialButtonsSharingElement.dataset.services = 'collections,vkontakte,facebook,odnoklassniki,gplus'
...
if (document.querySelector('article footer')) {
    document.querySelector('article footer')
      .insertBefore(socialSharingButtonsContainer, document.querySelector('.td-post-next-prev'))
}
...
document.querySelector('.td-mobile-container .td-menu-socials').appendChild(okButtonMobile);
